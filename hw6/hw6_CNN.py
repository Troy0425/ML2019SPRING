...
from keras.layers import LSTM, GRU, Conv1D, MaxPooling1D,BatchNormalization
...
model = Sequential()
model.add(Conv1D(filters=256,kernel_size=3,padding="same",activation='relu',input_shape = (length, dimension)))
